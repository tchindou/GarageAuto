...
<head>
    ...
    <style>
        ...
        *,
        ...
        .bg-red-50 {
            --bg-opacity: 1;
            background-color: rgb(254 242 242 / var(--bg-opacity))
        }
        ...
        .from-gray-700\/50 {
            --gradient-from: rgb(55 65 81 / 0.5);
        ...
        .text-gray-600 {
            --text-opacity: 1;
            color: rgb(75 85 99 / var(--text-opacity))
        }
        ...
        .shadow-gray-500\/20 {
            --shadow-color: rgb(107 114 128 / 0.2);
        ...
        .selection\:bg-red-500 *::selection {
            --bg-opacity: 1;
            background-color: rgb(239 68 68 / var(--bg-opacity))
        }
        ...
        .hover\:text-gray-700:hover {
            --text-opacity: 1;
            color: rgb(55 65 81 / var(--text-opacity))
        }
